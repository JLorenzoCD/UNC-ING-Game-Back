...
@pytest.mark.parametrize("set_type, card_names, quin_play_expected, quin_count_expected", [
    # PARKER_PYNE
    ...
    # HERCULE_POIROT
    (SetType.HERCULE_POIROT, ["HERCULE POIROT", "HERCULE POIROT", "HERCULE POIROT"], False, 0),
    (SetType.HERCULE_POIROT, ["HERCULE POIROT", "HERCULE POIROT", "HARLEY QUIN WILDCARD"], True, 1),
    (SetType.HERCULE_POIROT, ["HERCULE POIROT", "HARLEY QUIN WILDCARD", "HARLEY QUIN WILDCARD"], True, 2),
    # MISS_MARPLE
    (SetType.MISS_MARPLE, ["MISS MARPLE", "MISS MARPLE", "MISS MARPLE"], False, 0),
    (SetType.MISS_MARPLE, ["MISS MARPLE", "MISS MARPLE", "HARLEY QUIN WILDCARD"], True, 1),
    (SetType.MISS_MARPLE, ["MISS MARPLE", "HARLEY QUIN WILDCARD", "HARLEY QUIN WILDCARD"], True, 2),
    # MR_SATTERTHWAITE
    (SetType.MR_SATTERTHWAITE, ["MR SATTERTHWAITE", "MR SATTERTHWAITE"], False, 0),
    (SetType.MR_SATTERTHWAITE, ["MR SATTERTHWAITE", "HARLEY QUIN WILDCARD"], True, 1),
])

def test_create_set_valid_combinations(db_session, client, set_type, card_names, quin_play_expected, quin_count_expected):
